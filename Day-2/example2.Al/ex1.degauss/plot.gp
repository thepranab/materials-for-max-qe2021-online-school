...
plot \
     ...
     'm-v.k4.dat'    w l lt 4 lw 2, \
     'm-v.k8.dat'    w l lt 6 lw 2, \
     'm-v.k12.dat'   w l lt 7 lw 2, \
     'm-v.k16.dat'   w l lt 8 lw 2
pause -1
...
plot \
     ...
     'gauss.k8.dat'  w l lt 2 dt (6,6), \
     'gauss.k12.dat' w l lt 3 dt (6,6), \
     'm-p.k4.dat'    w l lt 4 lw 2, \
     'm-p.k8.dat'    w l lt 6 lw 2, \
     'm-p.k12.dat'   w l lt 7 lw 2, \
     'm-p.k16.dat'   w l lt 8 lw 2
pause -1
